...
#[OA\Schema(
    ...
    type: "object",
    properties: [
        new OA\Property(property: "data", type: "array", items: new OA\Items(ref: "#/components/schemas/DeviceLocation")),
...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: "data", ref: "#/components/schemas/PaginatedDeviceLocation")
    ]
)]
...
#[OA\Schema(
    ...
    properties: [
        new OA\Property(property: "success", type: "boolean", example: true),
        new OA\Property(property: "data", ref: "#/components/schemas/DeviceLocation")
    ]
)]
