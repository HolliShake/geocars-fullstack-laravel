...
#[
    OA\Schema(
        schema: "DeviceWithLocations",
        title: "DeviceWithLocations",
        type: "object",
        properties: [
            new OA\Property(property: "id", type: "integer", readOnly: true),
            new OA\Property(property: "device_identifier", type: "string"),
...
#[
    OA\Schema(
        schema: "GetDeviceWithLocationsResponse200",
        type: "object",
        properties: [
            new OA\Property(
                property: "success",
            ...
            new OA\Property(
                property: "data",
                ref: "#/components/schemas/DeviceWithLocations",
            ),
        ],
    ),
]
class Device extends Model
{
    ...
    protected $fillable = ["device_identifier", "car_rental_id"];
